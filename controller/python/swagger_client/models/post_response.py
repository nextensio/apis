...
class PostResponse(object):
    ...
    @property
    def result(self):
        """Gets the result of this PostResponse.  # noqa: E501

        Result of the operation is \"ok\" or an error message.  # noqa: E501

        :return: The result of this PostResponse.  # noqa: E501
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this PostResponse.

        Result of the operation is \"ok\" or an error message.  # noqa: E501

        :param result: The result of this PostResponse.  # noqa: E501
        :type: str
        """
        if result is None:
